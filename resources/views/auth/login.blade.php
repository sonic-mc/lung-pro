                ...
                <div class="row g-0">
                    <div class="col-lg-6 hero-pane p-4 p-xl-5 d-none d-lg-flex align-items-center">
                        <div class="hero-content w-100">
                            <div class="resp-canvas mb-4" aria-hidden="true">
                                <svg viewBox="0 0 420 520" class="resp-svg" role="img" aria-label="Respiratory system visualization">
                                    <defs>
                                        ...
                                        <linearGradient id="lungR" x1="0" y1="0" x2="1" y2="1">
                                    ...
                                    <g>
                                        <path d="M210 35 C285 38, 345 84, 362 162 C372 208, 365 304, 336 368 C309 428, 268 470, 210 478 C152 470, 111 428, 84 368 C55 304, 48 208, 58 162 C75 84, 135 38, 210 35 Z" fill="url(#torso)" stroke="rgba(191,219,254,0.45)"/>
                                    </g>
                                    ...
                                    <g class="resp-breath">
                                        ...
                                        <path d="M205 170 C142 168, 102 210, 94 276 C86 340, 116 400, 168 420 C195 431, 208 402, 208 356 L208 183 C208 175, 207 171, 205 170Z" fill="url(#lungL)"/>
                                        <path d="M215 170 C278 168, 318 210, 326 276 C334 340, 304 400, 252 420 C225 431, 212 402, 212 356 L212 183 C212 175, 213 171, 215 170Z" fill="url(#lungR)"/>
                                        ...
                                        <circle class="lesion" cx="172" cy="262" r="22" fill="url(#lesionGlow)"/>
                            ...
                            <p class="text-white-50 mb-0">Real-time lung-focused decision support with explainable lesion localization for clinical workflows.</p>
                        </div>
                    </div>

                    <div class="col-lg-6">
                        <div class="p-4 p-lg-5">
                            <h1 class="h4 mb-3">LungCare AI Login</h1>
